...
export class OtpInput extends Component {
    ...
    getOtpValue = () =>
        (this.props as any).value
            ? (this.props as any).value.toString().split('')
            : []
    ...
    isInputValueValid = (value: any) => {
        const isTypeValid = (this.props as any).isInputNum
    ...
    renderInputs = () => {
        ...
        const dataCy = this.props as any['data-cy']
        const dataTestId = this.props as any['data-testid']
